...
const az = {foto}
const urlNews = 'https://newsapi.org/v2/everything?q=kesehatan&apiKey=2a387c9cad674d258d97be8d34e65189';
          ...
          <div className="row">
            ...
            <div className="col-md-9">
                {listNews.map((item, key) => {
                  ...
                  return <ListNews key ={key} title={item.title} img={src_img} date={item.date} content={content}/>;
                })}
            </div>
          </div>
      </div>
